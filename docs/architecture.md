...
**Never leaves your browser.** Your pasted timetable is parsed client-side and
kept in `localStorage`, along with your plan, your per-mod records, your consent
flag and your layout. `.ics` exports are generated locally.
...
| Term      | 1 to 10. A degree is a ten-term plan                                     |
