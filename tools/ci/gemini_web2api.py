# Vendored, not ours, and not edited. Source:
# https://github.com/Sophomoresty/gemini-web2api at commit
# 2bb988bfcbb82a7fab5d2c99aa5560ff40d64f7e, MIT licensed. Refresh it by
# replacing this file whole in a pull request, and move the sha above with it.
#
# Why it is in the repo rather than fetched at review time: the gemini job runs
# it beside the reviewer, in a job holding a token that can post comments. A
# file here is one the review of the pull request that adds it can read, and
# one that cannot change under us between runs. A url fetched at runtime is
# neither, whatever it is pinned to.
#
